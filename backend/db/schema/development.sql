...
VALUES ('MARS Wildlife Rescue Centre', 'www.marswildliferescue.com', '/MARS-Logo.png', 'David', 'Corvus', '250-337-2021', 'mars@marswildlife.com', '1331 Williams Beach Road,
...
VALUES
  ...
  (3, 'CERO 084', 10, 'Campbell River', '2024-03-28', FALSE, FALSE, 5, 'In the serene vicinity of Campbell River, a sub-adult Roosevelt Elk, once a sovereign of the forests. Was discovered in a precarious state, burdened by the limitations of a broken leg. Admitted to the wildlife rehabilitation hospital on March 28, 2024, under case number RELK 084, this noble creature faced a challenging ordeal, contending not only with the physical hindrances of its injury. But, also with infection and emaciation, a trio of hardships that severely tested its fortitude. The rehabilitation staff, aware of the critical care required, promptly devised a comprehensive treatment regimen. With the aim of mending its body and spirit.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 'PINN 1223', 7, 'Vancouver Island', '2022-05-10', FALSE, FALSE, 1, 'A Baby Seal was rescued from after a Boat Strike in the tranquil waters of Vancouver Island. The baby harbor seal, bearing the case number VASH 1223, bears testament to the harsh reality of human maritime activities, when it fell victim to a boat strike. Admitted to the MARS Wildlife Rescue Centre on May 10, 2022, this tiny seal pup faced a perilous journey to recovery while fighting to survive  head trauma and a fractured flipper. The dedicated team at the rescue center swiftly mobilized the seal pup. Employing a combination of trauma therapy, fluid therapy, and nutritional support to address the seals critical condition. With each passing day, the seals playful spirit is beginning to resurface.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1, 'BAEA 017', 1, 'Merville', '2021-07-05', FALSE, FALSE, 6, 'This adult Bald Eagle was rescued from a Power Line along the rugged cliffs of Merville. After finding itself tangled in the perils of modern infrastructure, and suffering a debilitating injury from a power line collision. The eagle was transported to the MARS Wildlife Rescue Centre on July 5, 2021. This majestic raptor bore the brunt of a broken wing and electrocution, necessitating immediate intervention. The skilled rehabilitation team orchestrated a comprehensive treatment plan encompassing: physiotherapy, antibiotics, and wing wrapping techniques to facilitate healing. As the eagles strength gradually returned, so did its ability to soar.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (2, 'LOCA 202', 6, 'Comox Lake', '2023-06-18', FALSE, FALSE, 6, 'This River Otter is recovering from a car strike along-side the serene waters of Comox Lake. The resilient river otter, identified as RORO 202, sustained multiple injuries in a car strike. And was admitted to the MARS Wildlife Rescue Centre on June 18, 2023, battling head trauma and emaciation, which challenges its survival in the wild. The rehabilitation team at MARS sprang into action, implementing trauma therapy, fluid therapy, and orphan care to nurse the otter back to health. With dedicated care and perseverance, RORO 202 embarked on a remarkable journey of recovery, embodying the indomitable spirit of wildlife in the face of urban perils.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (3, 'VATH 180', 4, 'Cowichan Lake', '2022-04-28', FALSE, FALSE, 5, 'This Varied Thrush is recovering from a window strike.The Varied Thrush, denoted as VATH 180, fell victim to the perils of reflective surfaces, in the idyllic woodlands of Vancouver Island. After sustaining these injuries it was transported to the MARS Wildlife Rescue Centre on April 28, 2022. This beautiful bird grappled with wing fractures and trauma, which impaired its ability to navigate its natural habitat. The skilled rehabilitation team at MARS orchestrated a tailored treatment plan, incorporating wing wrapping techniques, trauma therapy, and nutritional support to aid in the thrushs recovery. With patience and expertise, VATH 180 embarked on a journey of healing. ', NULL,CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

INSERT INTO patients (organization_id, patient_case, species_id, location_found, date_admitted, release_date, is_released, is_archived, age_range_id, story, image, created_at, updated_at)
VALUES
  (2, 'ENLU 212', 5, 'Victoria, BC', '2024-01-15', '2024-04-26', TRUE, FALSE, 1, 'On the tranquil shores of Victoria, a baby sea otter,  separated from its mother due to unforeseen circumstances, was found in need of urgent care. Admitted under case number SEO 212, on April 15, 2024, to the wildlife rehabilitation hospital. This young otter faced the challenges of orphanhood, emaciation, and a mild infection. The rehabilitation staff, recognizing the vulnerability of this tiny otter. Immediately initiated a specialized care plan focused on providing round-the-clock nutritional support and fluid therapy to ensure proper hydration. Each day brings new progress and hope for this resilient sea otter, symbolizing the enduring spirit of marine life in the face of adversity.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1, 'MARM 050', 9, 'Mt. Douglas Park, Victoria, BC', '2023-10-12', '2024-04-05', TRUE, FALSE, 3, 'A resilient Marmot recovering from a dog attack amidst the urban sprawl of Victoria, BC. This resourceful marmot, registered as PRLO 050, sustained severe injuries in the attack. Admitted to the MARS Wildlife Rescue Centre on August 12, 2022, this tenacious mammal has grappled with broken bones and infections, necessitating urgent around the clock medical attention. The dedicated team of veterinarians and caregivers at MARS devised a holistic treatment regimen, combining trauma therapy, antibiotics, and nutritional support to aid in the marmots recuperation. With each passing day, PRLO 050 showcased remarkable resilience, offering a poignant reminder of the symbiotic relationship between wildlife and urban environments.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (1, 'VATH 1020', 4, 'Courtenay', '2023-12-14', '2024-04-03', TRUE, FALSE, 6, 'In the heart of Courtenay, an adult Varied Thrush experienced the unfortunate consequence of human architecture intersecting with the natural world, falling victim to a window strike. With its vibrant plumage dulled by the incident, it was admitted under case number VATH 1020 to the wildlife rehabilitation hospital on December 14, 2023. The rehabilitation staff, upon assessing its condition, recognized the immediate need for a delicate balance of intervention and care to nurse this small, yet striking bird back to health. The collision had not only left physical injuries but had also compromised the thrushs ability to forage, casting a shadow over its independence.\n\nThe treatment plan for the Varied Thrush was two-fold, focusing primarily on trauma care to address the immediate impact of the collision. This care was complemented by nutritional support, crucial for replenishing the energy reserves depleted in the wake of its trauma. The rehabilitation staffs expertise and compassionate care were instrumental in gradually restoring the birds strength, each day marking a tangible step towards recovery. In this nurturing environment, the thrush slowly began to reclaim its vigor, embodying the resilience of wildlife in the face of human-induced challenges. Through the dedicated efforts of the rehabilitation staff, this Varied Thrushs journey from vulnerability back to vitality highlights the pivotal role of wildlife rehabilitation in bridging the gap between humans and the natural world they share.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (3, 'LESA 055', 14, 'Tofino', '2022-05-30', '2022-07-03', TRUE, FALSE, 6, 'This Least Sandpiper is recovering from a cat attack along the stormy shores of Tofino. The delicate Least Sandpiper, identified as LESA 055, encountered the hazards of predatory house pets, and sustained multiple injuries Admitted to the MARS Wildlife Rescue Centre on May 30, 2022, this petite shorebird faced wing fractures, puncture wounds, and stress. Each a significant  challenge exacerbated by its migratory lifestyle. The compassionate team at MARS swiftly intervened, employing wing wrapping techniques, antibiotics, physiotherapy, and nutritional support to aid in the sandpipers rehabilitation. As LESA 055 regained its strength and agility, it epitomized the resilience of migratory species navigating perilous human-dominated landscapes.', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
