...
const HomePage = () => {
  return (
    <Grid container className="home-page" spacing={3} style={{ backgroundImage: `url(/raccoon.jpg)`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', width: 'auto', display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      
      <Grid item xs={12} md={6} style={{ alignSelf: 'flex-start', paddingLeft: '20px'}}>
      ...
      <Grid item xs={12} md={6} style={{ alignSelf: 'flex-start', marginTop: '-25px' }}>
