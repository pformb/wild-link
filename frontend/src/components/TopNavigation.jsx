    ...
    <AppBar position="static" style={{ 
      ...
      <Toolbar style={{ padding: 0 }}>
        <Box display="flex" justifyContent="flex-start" style={{ flexGrow: 3 }}>
          <Typography variant="h6" style={{ fontFamily: "'Luckiest Guy', cursive", fontSize: '38px' }}>
            <RouterLink to="/home" style={{ textDecoration: 'none', color: 'white', paddingLeft: '10px' }}>Home </RouterLink>
          </Typography>
        </Box>
